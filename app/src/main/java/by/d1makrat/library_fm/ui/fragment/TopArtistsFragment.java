...
import by.d1makrat.library_fm.asynctask.GetUserTopArtistsAsynctask;

import static by.d1makrat.library_fm.Constants.PERIOD_KEY;

public class TopArtistsFragment extends ScrobblesListFragment {
    ...
    public void loadItemsFromWeb() {
        ...
        mGetItemsAsynctask = new GetUserTopArtistsAsynctask(this);
